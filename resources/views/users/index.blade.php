...
@section('content')
   ...
   <div class="overflow-auto">
    ...
    <a class="bt btn-danger mt-3 mb-3" href="{{ route('users.pdf') }}">
            ...
            <tbody class="">
                @forelse ($users as $user)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('user.edit', $user) }}" class="btn btn-info" title="Editar">
                        ...
                        <td>
                                ...
                                <form action="{{ route('user.destroy', $user) }}" method="post" title="Eliminar"
                                    class="user-delete">
                                    @csrf
                                    @method('delete')
